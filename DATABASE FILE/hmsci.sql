...
(1, 'Danny G. Collins', 'danny@mail.com', 'acc8520', '86 Courtright Street', '4455668877'),
(2, 'Carlos T. Cave', 'carlos@mail.com', 'password', '18 Kidd Avenue', '4582221100'),
(3, 'Elizabeth D. Hamada', 'elizabeth@mail.com', 'password123', '62 Barnes Street', '6458886980');
...
(4, 6, 'Op104', 'Test. Test. Test. Test. Test. Test. Test. Test. Test.&nbsp;', 2335, 1651170171, 'paid'),
(3, 5, 'Demo Payment', 'This is a demo payment', 125, 1651162669, 'paid');
...
(2, 'Benzonatate', 5, 'Benzonatate is a non-narcotic cough medicine.  Benzonatate works by numbing the throat and lungs, making the cough reflex less active.', '44', 'TESSALON', '112'),
(3, 'Cephalexin', 5, 'Cephalexin is a cephalosporin (SEF a low spor in) antibiotic. It works by fighting bacteria in your body.', '27', 'Lupin Pharmaceuticals', '68'),
(4, 'Lisinopril', 4, 'Lisinopril is used to treat high blood pressure (hypertension) in adults and children who are at least 6 years old.', '30', 'Apotex', '110'),
(5, 'Methotrexate', 4, 'Methotrexate is used to treat leukemia and certain types of cancer of the breast, skin, head and neck, lung, or uterus.', '9', 'Bristol Myers Squibb', '80');
...
(3, 'Liquid', 'A liquid may also be called a ‘mixture’, ‘solution’ or ‘syrup’. Many common liquids are now available without any added colouring or sugar.'),
(4, 'Tablet', 'The active ingredient is combined with another substance and pressed into a round or oval solid shape. There are different types of tablet. Soluble or dispersible tablets can safely be dissolved in water.'),
(5, 'Capsules', 'The active part of the medicine is contained inside a plastic shell that dissolves slowly in the stomach. You can take some capsules apart and mix the contents with your child’s favourite food. '),
(6, 'Topical medicines', 'These are creams, lotions or ointments applied directly onto the skin. They come in tubs, bottles or tubes depending on the type of medicine. '),
(7, 'Drops', 'These are often used where the active part of the medicine works best if it reaches the affected area directly. They tend to be used for eye, ear or nose.'),
(8, 'Inhalers', 'The active part of the medicine is released under pressure directly into the lungs. Young children may need to use a ‘spacer’ device to take the medicine properly.'),
(9, 'Injections', 'There are different types of injection, in how and where they\'re injected. Subcutaneous or SC injections are given just under the surface of the skin.'),
(10, 'Implants or patches', 'These medicines are absorbed through the skin, such as nicotine patches for help in giving up smoking, or contraceptive implants.');
...
(1, 'Demo Notice One', 'This is a demo text. This is a demo text.  This is a demo text. This is a demo text. This is a demo text. This is a demo text. This is a demo text. ', 1647298800),
(2, 'Demo Notice Two', 'This is a demo text. This is a demo text. This is a demo text. This is a demo text. This is a demo text. This is a demo text. ', 1648764000),
(3, 'Testing HMS - CI', 'This is a demo text. This is a demo text. This is a demo text. ', 1651183200);
...
(3, 'other', 'This is a sample report.', 1651161137, 8, 5),
(4, 'operation', 'Op104', 1651170081, 11, 6);
